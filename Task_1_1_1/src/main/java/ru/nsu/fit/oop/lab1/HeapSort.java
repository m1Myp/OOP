...
public class HeapSort {
     ...
     * @param x 1st part of id of this elements
     * @param y 2nd part of id of this elements
     */
     ...
     */
    private static void siftDown(int[] arr, int id, int len) {
        int current = id;
        int left = id * 2 + 1;
        int right = id * 2 + 2;
